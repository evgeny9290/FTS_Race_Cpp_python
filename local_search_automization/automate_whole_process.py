...
# spec = [
#     ('backup', numba.boolean),
#     ('problemGenerator_exe_path', numba.string),
#     ('python', numba.boolean),
#     ('alg_run_time', numba.float64),
#     ('optuna_run_time', numba.float64),
#     ('cpp_dataframes_path', numba.string),
#     ('python_dataframes_path', numba.string),
#     ('graphs_path', numba.string),
#     ('results_path', numba.string),
#     ('run_file_path', numba.string),
#     ('LS_exe', numba.string),
#     ('best_params_path', numba.string),
#     ('algorithms', numba.string[:]),
#     ('problem_seeds', numba.string[:]),
#     ('algo_seed', numba.string),
#     ('best_val_for_alg_path', numba.string),
#     ('num_algos', numba.int64),
#     ('num_problems', numba.int64),
#     ('num_iterations', numba.int64),
#     ('num_workers', numba.int64),
#     ('unique_trials', numba.boolean)
# ]
...
class COPLocalSearchAlgorithmsAveraging:
    def __init__(self, problemGenerator_exe_path, results_path, run_file_path,
        ...
        Args:
            ...
            unique_trials (bool, optional): True if want all optuna trials to be unique (can take time) else False.
    ...
    def run_optuna_param_optimization(self):  # only running optuna
        ...
        """
        try:
            if not os.path.exists(self.best_val_for_alg_path + '../..'):
...
if __name__ == '__main__':
    ...
    for algo_seed in algo_seeds:
        problemCreatorPath = rf'../LocalSearchProblemGenerator/Debug/LocalSearchProblemGenerator.exe'
        ...
        LS_exe = rf'../LocalSearch/Debug/LocalSearch.exe'
